...
export const DOCUMENT_PDF_FILE_NAME =
    "文書.pdf";
...
const PDF_CAPTURE_SCALE =
    2;


/* =========================================================
   File System Access API local types
   ========================================================= */
...
export class PdfSaveCancelledError
    extends Error {
...
async function savePdfBlob(
    ...
    if (
        ...
        error
             ...
             */
            console.warn(
                "File System Access APIによるPDF保存に失敗したため、通常ダウンロードへ切り替えます。",
                error
            );
        }
    }
