 ...
 * ID指定で1件取得する。
 */
export async function getPresetDocument(
    id: string
 ...
 * idが同じ場合は洗い替える。
 */
export async function putPresetDocument(
 ...
 * 定型印刷物を削除する。
 */
export async function deletePresetDocument(
    id: string
): Promise<void> {
