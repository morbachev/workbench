...
function validateImportData(
     ...
     */
    return value as Gosplan13ExportData;
}
...
export function restoreImportData(
    ...
    if (
        ...
        throw new Error(
            "このJSONには、現在の画面で扱える数を超えるラベルが保存されています。",
        );
    }
